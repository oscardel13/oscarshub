...
const InfoBarSocials = () =>{
    return (
        <div className='flex flex-row justify-center space-x-8 h-20 w-full bg-[rgba(37,37,50,0.98)]'>
            ...
            <a className='flex items-center h-10 w-6' href="https://hub.docker.com/u/oscardel13">
                <Docker className=''/>
            </a>
        </div>
    )
